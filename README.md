...
# News 
* **24 April 2022**: added a colab notebook in: **demo.ipynb**. Unfortunately, results obtained from the notebook are different from what I get on my pc. I am trying to find out the reason of this. Any help is welcome :)
